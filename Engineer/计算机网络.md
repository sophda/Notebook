...
![image-20251006021307089](src/计算机网络_img/image-20251006021307089.png)

![image-20251006021322371](src/计算机网络_img/image-20251006021322371.png)
...
![image-20251006163717842](src/计算机网络_img/image-20251006163717842.png)
...
![image-20230403211852008](src/计算机网络_img/image-20230403211852008.png)
...
图示如下
![https://cdn.llfc.club/1540562-20190417002428451-62583604.jpg](src/计算机网络_img/1540562-20190417002428451-62583604.jpg)
...
![TCP 头格式](src/计算机网络_img/format,png-20230309230534096.png)
...
![TCP 四元组](src/计算机网络_img/format,png-20230309230433082.png)
...
![TCP 三次握手](src/计算机网络_img/TCP三次握手.drawio.png)

**为什么不能是两次握手？**

如果是两次握手，那么客户端在发送第一次syn的时候，服务端就会建立连接，进而想客户端发送数据，如果是历史连接，服务端就会建立旧的连接导致资源浪费。

![两次握手会造成资源浪费](src/计算机网络_img/format,png-20230309230636571.png)
...
![客户端主动关闭连接 —— TCP 四次挥手](src/计算机网络_img/format,png-20230309230614791.png)
...
![img](src/计算机网络_img/第二次挥手丢失.png)

---

对于调用close关闭的连接，如果在60秒后还没有收到，客户端（主动关闭方）的连接就会关闭，如图所示：

![img](src/计算机网络_img/fin_wait_2.drawio.png)
...
![img](src/计算机网络_img/第三次挥手丢失.drawio.png)
...
![img](src/计算机网络_img/第四次挥手丢失drawio.drawio.png)
...
![UDP 头部格式](src/计算机网络_img/format,png-20230309230439961.png)
...
![img](src/计算机网络_img/tcp和udp模块.jpeg)
