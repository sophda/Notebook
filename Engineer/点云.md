...
\right]
$$
![img](src/点云/v2-e561797b4d5652c8507c109462f37ce0_r.jpg)

该式满足：

![image-20230413165259635](src/点云/image-20230413165259635.png)

**复合变换：**
$$
^AP=^{A}_{B}P^{B}P+^AP_{BOPG}
$$
![img](src/点云/v2-cbc271bf3a395af3e5a2562a280ed669_r.jpg)

![image-20230413165546501](src/点云/image-20230413165546501.png)

**欧拉角：**（欧拉角是基于物体本身的坐标系进行变换的，基于物体本身的坐标系进行变换需要右乘） ，如下图所示：

![动图](src/点云/v2-35da80e428ca5750491ffd2770e187e1_720w.webp)

该图表示了（z,x,z'）的变换过程，那么变换矩阵就是：

![image-20230413221359219](src/点云/image-20230413221359219.png)
...
![image-20230524180624683](src/点云/image-20230524180624683.png)
...
![image-20230524181128753](src/点云/image-20230524181128753.png)

![image-20230524181142075](src/点云/image-20230524181142075.png)
...
![image-20230524181538473](src/点云/image-20230524181538473.png)

![image-20230524181557639](src/点云/image-20230524181557639.png)
