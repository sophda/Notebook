...
![img](src/CUDA/v2-aa6aa453ff39aa7078dde59b59b512d8_1440w.jpg)
...
![img](src/CUDA/v2-735b66bba1a64de5a87a0e4309d14c5d_1440w.jpg)
...
![image-20250309204217107](src/CUDA/image-20250309204217107.png)
...
![image-20250309210542437](src/CUDA/image-20250309210542437.png)
...
![image-20250310230852629](src/CUDA/image-20250310230852629.png)
...
![img](src/CUDA/kernel_func-4689403a059059ccbd20a07cae37d1ed.png)

![img](src/CUDA/exec_model_SM-fbe5ceb5d09beb2c1dffc4abd2d5194c.jpg)



## 线程的层次结构

![img](src/CUDA/thread_grid-31a1c0b8068c1ee9dc8c0cb0cadcdc83.jpg)
...
![img](src/CUDA/sm_detail-abf633eeff37ac3ff2af267cbda3c2fa.png)
...
![img](src/CUDA/memory_arch-81fe47f774b7aa36be52951b911840f2.jpg)

CPU 与 GPU 之间的通信开销是比较大的。

---

![img](src/CUDA/dma_d2h-b202ed101a13c91ff687033a2ceade5d.png)
...
![img](src/CUDA/fess-f93e515382eba41079cefa5f245aeaab.png)



## 变量内存空间说明符

![img](src/CUDA/vmss-1d8a1662941b3feed0bed96d3a01a4bd-17494375444563.png)

![img](src/CUDA/fsmss_overview-42c7582e172bba6438555070b29eaeaf.png)



## CUDA内存管理

![img](src/CUDA/cuda_mem-7519ca351e0a94a57c376d6258060d46.jpg)

![img](src/CUDA/cuda_mem_func-83c90e105996f31890cc2eb8c4533b6f.png)
...
![img](src/CUDA/A100-f2889fca404e76f60c2a9bf2a12f0d08.png)
...
![img](src/CUDA/A100_SM-41eb6b4cdad59639be480d5c7e671be5.jpg)
...
![cuda core](src/CUDA/27447c25f2c4e8fa974a26bbb5b51644.png)
...
![img](src/CUDA/A100_params-4818f664f05838d991b08b303bce05d0.png)
...
![img](src/CUDA/SM_mem_detail-36b4cf3dce39c8c50d7f8b5ada9d7b5e.jpg)
...
![img](src/CUDA/cuda_core-19882636aa22b20a46207a7a7f7f9b84.png)
...
![img](src/CUDA/warp_diverage-b67fa64a2658359bc44972b25e9a2e9b.png)

为了更加清晰的说明线程束发散，可以看看如下图例：

![img](src/CUDA/warp_diverage2-19b2986805c9fb6c6eff1c2bf0970b27.png)
...
![image-20250610012055775](src/CUDA/image-20250610012055775.png)
...
![image-20250610013014615](src/CUDA/image-20250610013014615.png)
...
![picture 0](src/CUDA/0b35adb64a964e56018dc9fb7277269a3efa72b1526058609e0860f33e00426b-b3a7e4298b605de4f56edfff09169f1a.png)
...
![picture 1](src/CUDA/6f55c7f9531e5efd955eab9a572ef5406733498bc0b50abed0e73985d88c840b-a41ab97d63a8f3d017bacaede20e8b5e.png)
