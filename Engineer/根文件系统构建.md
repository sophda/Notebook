...
![](assets/根文件系统构建_img/2023-01-24-02-25-46-image.png)
...
![](assets/根文件系统构建_img/2023-01-24-02-28-30-image.png)
...
![](assets/根文件系统构建_img/2023-01-28-05-42-32-image.png)

设置以太网端口的IP地址，也就是服务器的IP地址，同时设置子网掩码和网关

![](assets/根文件系统构建_img/2023-01-28-05-43-23-image.png)
...
![](assets/根文件系统构建_img/2023-01-31-06-37-41-image.png)
...
![](assets/根文件系统构建_img/2023-02-05-18-11-03-image.png)
...
```
 sd卡尝试
 setenv bootargs console=tty1 console=ttyAMA0,115200 root=/dev/mmcblk1p1 rootfstype=ext4 rootwait blkdevparts=mmcblk0:1M(fastboot),1M(bootargs),10M(kernel),6144M(rootfs),-(others)  ipaddr=192.168.31.66 gateway=192.168.31.1 netmask=255.255.255.0 netdev=eth0
...
```
ifconfig eth0 192.168.31.66 netmask 255.255.255.0
